...
def main():
    ...
    if args.verbose:
        print(f"Running api_tester in verbose mode")
    
    # Placeholder implementation
    print(f"Api Tester started...")
